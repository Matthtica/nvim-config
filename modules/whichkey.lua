...
local keymap = {
    ...
    p = {
        name = "vim-plug",
        i = {':PlugInstall<CR>'     , 'PlugInstall'     },
        u = {':PlugUpdate<CR>'      , 'PlugUpdate'      },
        g = {':PlugUpgrade<CR>'     , 'PlugUpgrade'     },
        c = {':PlugClean<CR>'       , 'PlugClean'       },
    }
}
...
wk.setup {
    ...
    window = {
      ...
      margin = { 1, 4, 1, 4 }, -- extra window margin [top, right, bottom, left]
